...
\address{Website: \href{www.jtolia.com}{www.jtolia.com} \\ Email: \href{mailto:joytolia@hotmail.com}{joytolia@hotmail.com} \\ Phone: (+44)~$\cdot$~7877~$\cdot$~697~$\cdot$~113} % Your phone number and email
%\address{135 Shrewsbury Road \\ London \\ N11 2LN} % Your address
...
\begin{rSection}{Skills}
	Computing: Python (Advanced), Matlab (Advanced), VBA (Advanced), Microsoft Excel (Advanced), LaTeX (Advanced), Unix (Intermediate), AWS (Intermediate), SQL (Intermediate), q/KDB+ (Basic), C++ (Basic)
\end{rSection}
\begin{rSection}{Work Experience}
\begin{rSubsection}{Norges Bank Investment Management}{October 2017 - Present}{FX Quantitative Trader}{}
	\item Researching, generating and maintaining systematic trading strategies for spot FX using Python and Matlab. Focusing on strategies with a holding period between hourly and monthly
	\item Created a web based application in AWS using Python, MSSQL, MongoDB with high availability for transaction cost analysis
	\item Creating and maintaining company specific Python package to give Python users an API to connect to databases, run timeseries calculations, utilise automated email facilities, etc.
	\item Writing internal papers on topics such as the inverse of a covariance matrix and deriving its practical impact in Markowitz optimisation and linear regression
	\item Supervising an MSc university student on a project about analysis of price tick data
	\item Creating long term discretionary positions using portfolio optimisation to reduce exposure to certain risk factors
	\item Working with cross asset data such as commodities, equity indices and fixed income to help produce diverse signals to trade FX
	\item Trading 20 free floating currencies in spot FX for execution purposes for the whole fund
	\item Systematising the FX execution of the fund by building intra-day models balancing between alpha, risk and transaction costs
	\item Built the code for backtesting infrastructure over all asset classes, from the ground up. The run time is optimised using object orientated code, parallelisation and dependency networks. Produces structured summaries to compare numerous parameters efficiently
\end{rSubsection}
\begin{rSubsection}{Systematica Investments}{September 2016 - September 2017}{Quantitative Researcher}{}
...
\end{rSubsection}
\begin{rSubsection}{Royal Bank of Scotland}{April 2016 - August 2016}{Rates Quantitative Analyst}{}
...
\begin{rSubsection}{Royal Bank of Scotland}{September 2015 - March 2016}{Structuring Analyst}{}
...
\begin{rSubsection}{Warwick University}{June 2015 - August 2015}{Undergraduate Researcher}{}
...
\begin{rSubsection}{Warwick University}{September 2014 - June 2015}{Mathematics Supervisor}{}
...
%------------------------------------------------
%(London, UK)
\begin{rSubsection}{Royal Bank of Scotland}{July 2014 - September 2014}{Sales \& Trading Summer Intern}{}
...
\begin{rSection}{Education}
	\begin{rSubsection}{Certificate in Quantitative Finance}{January 2016 - August 2016}{CQF}{}
	...
	\end{rSubsection}
	\begin{rSubsection}{University of Warwick}{October 2011 - June 2015}{First Class MMath in Mathematics}{}
