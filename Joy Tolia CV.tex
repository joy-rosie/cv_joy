...
\begin{rSubsection}{\href{https://www.nbim.no/}{Norges Bank Investment Management}}{October 2017 - Present}{FX Trader}{}
	\item Created a web based application in the cloud (AWS) using Python, MSSQL, MongoDB for transaction cost analysis utilising large data sets with interactive visualisation to help improve our trading decisions
