...
\address{
	Website: \href{https://joy-rosie.github.io/}{https://joy-rosie.github.io/} \\
...
\begin{rSubsection}{\href{https://www.auguration.com/}{Auguration}}{July 2021 - Current}{Senior Quantitative Researcher}{}
	\item Researching equity market neutral and statistical arbitrage alpha signals, this involves end to end work; getting raw data, transforming data, modelling and simulations
	\item Managing a team of researchers and developers to get the live trading systems up and running
	\item Hyperparameter tuning for multi period optimisation for simulations and live trading systems
	\item Building and maintaining a graph based code structure for research and live trading using Java and Python
	\item Built tick data decoder across multiple exchanges to allow use for intraday trading signals
\end{rSubsection}
